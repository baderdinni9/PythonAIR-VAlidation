...
******************************************************
Parse Reinsurance Rejection Validation Script
******************************************************
...
str1 = "_RejectionFileReinsurance"
...
actualcolumns = [r'ContractID',	r'InsuredName',	r'Producer',	r'Underwriter',	r'Branch',	r'ExpiringContract',	r'Status',	r'InceptionDate',	r'ExpirationDate',	r'Perils',	r'LOB',	r'Form',
                 ...
                 r'SublimitLimitB',	r'SublimitLimitC',	r'SublimitLimitD',	r'SublimitAttachA',	r'SublimitAttachB',	r'SublimitAttachC',	r'SublimitAttachD',	r'SublimitDedAmt1',	r'SublimitDedAmt2']
...
datacontract = datafile[[r'ContractID',	r'InsuredName',	r'Producer',	r'Underwriter',	r'Branch',	r'ExpiringContract',	r'Status',	r'InceptionDate',	r'ExpirationDate',	r'Perils',
                     ...
                     r'SublimitAttachA',	r'SublimitAttachB',	r'SublimitAttachC',	r'SublimitAttachD',	r'SublimitDedAmt1',	r'SublimitDedAmt2']]
