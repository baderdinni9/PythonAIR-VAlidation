...
class Database:
    ...
    def fetchData(self, resultDb, ValID, TCID, TPID):
        ...
        script = 'select * from '+ resultDb + '..[MastertemptableContract_' + ValID + '_' + TCID + '_' + TPID + ']'
...
for file in files:
    ...
    datafile[['LayerID']] = datafile[['LayerID']].astype(object)
...
comparedata = pd.merge(datafilenew, DatabaseContract, left_on=['ContractID_File', 'InsuredName_File'],
                       right_on=['ContractID_DB', 'InsuredName_DB'], how='outer')
